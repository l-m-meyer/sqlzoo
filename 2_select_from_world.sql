...
-- 7. A country is big if it has an area of more than
...
-- 9. Show the name and population in millions and the GDP
...
-- GDP of at least one trillion. Round this value to the nearest 1000.
...
-- 12. Show the name and the capital where the first letters of each match. Don't include countries
